...
def add_dependency(project_name, dependency_name):
    project = get_project(project_name)
    dependency = get_project(dependency_name)
    project.add_dependency(dependency)

    for configuration in project.configurations:
        project.add_header_search_path(configuration[1], dependency_name)
